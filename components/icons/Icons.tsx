...
export const LogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke="none">
    <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5-10-5-10 5zM12 14.47l-8-4v6.06l8 4 8-4v-6.06l-8 4z"></path>
  </svg>
);
...
export const SubmissionsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const WandIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c.238.132.44.29.6.471m-.601-.471c.238.132.44.29.6.471m6.035 8.86a2.25 2.25 0 00-1.591.659v5.714m-12.07-1.591L5 14.5m1.341 4.341L5 14.5m1.341 4.341a2.25 2.25 0 001.591.659v5.714m0-5.714a2.25 2.25 0 00-1.591.659L5 14.5m1.341 4.341L5 14.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-2.25 2.25m0 0l-2.25 2.25M17.25 10.5l2.25 2.25m0 0l2.25 2.25M17.25 10.5l-2.25-2.25m2.25 2.25l2.25-2.25" />
  </svg>
);

export const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.67c.625.933.924 2.058.924 3.182s-.3 2.25-.924 3.182zM12 13.5a3 3 0 100-6 3 3 0 000 6z" />
  </svg>
);
...
export const ScaleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 01-2.036.243c-2.132 0-4.14-.817-5.62-2.24l-2.743-2.743a3.75 3.75 0 00-5.304 0l-2.743 2.743A5.988 5.988 0 013 16.486c-.642 0-1.273-.093-1.875-.274-.482-.174-.711-.703-.59-1.202L3 4.971m15.75 0A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0l1.107-4.426m-15.75 0l-1.107-4.426" />
  </svg>
);

export const TrophyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 01-4.874-1.942 1.5 1.5 0 01-.626-1.431V5.25a1.5 1.5 0 011.5-1.5h13.5a1.5 1.5 0 011.5 1.5v10.127a1.5 1.5 0 01-.626 1.431A9.75 9.75 0 0116.5 18.75z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 14.25v5.25m-4.5-5.25v5.25m9-5.25v5.25M9 5.25V3.75a3 3 0 016 0v1.5" />
  </svg>
);
